  ...
  try {
    for (
      var a = e.split(".").map((e) => parseInt(e, 10) || 0),
        i = t.split(".").map((e) => parseInt(e, 10) || 0);
      a.length < 3;
    )
      a.push(0);
...
async function generatePluginFingerprint(e, t) {
  try {
    var a = {
        id: e.id || "obsidian-content-protection",
        version: e.version,
        author: e.author,
        name: e.name,
        path: t.replace(/\\/g, "/"),
      ...
      i = generateSecureHash(JSON.stringify(a, Object.keys(a).sort()));
    return i && "function" == typeof i.then ? await i : i;
  } catch (e) {
    return null;
  }
}
async function validatePluginIntegrity(e, t) {
  try {
    ...
    return (await generatePluginFingerprint(e, t))
      ? ((a = "obsidian-content-protection"),
        (i = "ytmaps"),
        e.id === a &&
          e.author === i &&
          0 <= compareVersions(e.version, "1.3.0") &&
          ((s = generateSecureHash(JSON.stringify({ id: a, author: i }))),
          (l = generateSecureHash(
            JSON.stringify({ id: e.id, author: e.author }),
          )),
          (r = s && "function" == typeof s.then ? await s : s),
          (l && "function" == typeof l.then ? await l : l) === r))
      : !1;
  } catch (e) {
    return !1;
  }
...
let CLI_CATEGORIES = [
  ...
  CLI_COMMANDS = [
    ...
    },
    {
      ...
      params: [
        ...
        { name: "inline", label: "不换行追加", type: "flag", required: !1 },
        { name: "open", label: "执行后打开", type: "flag", required: !1 },
      ],
    },
    {
      id: "daily:prepend",
      ...
      params: [
        ...
        { name: "inline", label: "不换行插入", type: "flag", required: !1 },
        { name: "open", label: "执行后打开", type: "flag", required: !1 },
      ],
    },
    {
    ...
    },
    {
      ...
      desc: "列出仓库中的文件",
      params: [
        { name: "folder", label: "文件夹", type: "text", required: !1 },
        {
          name: "ext",
          label: "扩展名",
          type: "text",
        ...
        { name: "total", label: "仅显示数量", type: "flag", required: !1 },
      ],
    },
    {
      id: "open",
      ...
      desc: "打开指定文件",
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "newtab", label: "新标签页", type: "flag", required: !1 },
      ],
    },
    {
      id: "create",
      ...
      params: [
        ...
        { name: "overwrite", label: "覆盖已有", type: "flag", required: !1 },
        { name: "open", label: "创建后打开", type: "flag", required: !1 },
        { name: "newtab", label: "新标签页", type: "flag", required: !1 },
      ],
    },
    {
    ...
    },
    {
      ...
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "content", label: "内容", type: "textarea", required: !0 },
        { name: "inline", label: "不换行", type: "flag", required: !1 },
      ],
    },
    {
      id: "prepend",
    ...
    },
    {
      ...
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "to", label: "目标路径", type: "text", required: !0 },
      ],
    },
    {
      id: "rename",
      ...
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "name", label: "新名称", type: "text", required: !0 },
      ],
    },
    {
      id: "delete",
      ...
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "permanent", label: "永久删除", type: "flag", required: !1 },
      ],
      dangerous: !0,
    },
    {
      ...
      desc: "显示文件夹信息",
      params: [
        { name: "path", label: "路径", type: "text", required: !0 },
        {
          name: "info",
          label: "类型",
          type: "select",
    ...
    },
    {
      ...
      desc: "列出仓库文件夹",
      params: [
        { name: "folder", label: "父文件夹", type: "text", required: !1 },
        { name: "total", label: "仅数量", type: "flag", required: !1 },
      ],
    },
    {
      id: "wordcount",
      ...
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "words", label: "仅字数", type: "flag", required: !1 },
        { name: "characters", label: "仅字符数", type: "flag", required: !1 },
      ],
    },
    {
      id: "search",
      ...
      params: [
        ...
        { name: "path", label: "限定文件夹", type: "text", required: !1 },
        { name: "limit", label: "最大数", type: "number", required: !1 },
        {
          name: "format",
          label: "格式",
          type: "select",
        ...
        { name: "total", label: "仅数量", type: "flag", required: !1 },
        { name: "case", label: "区分大小写", type: "flag", required: !1 },
      ],
    },
    {
      id: "search:context",
      ...
      desc: "搜索并显示匹配行",
      params: [
        { name: "query", label: "关键词", type: "text", required: !0 },
        { name: "path", label: "限定文件夹", type: "text", required: !1 },
        { name: "limit", label: "最大数", type: "number", required: !1 },
        {
          name: "format",
    ...
    },
    {
      ...
      name: "打开搜索面板",
      desc: "打开搜索视图",
      params: [{ name: "query", label: "关键词", type: "text", required: !1 }],
    },
    {
      id: "tasks",
      category: "tasks",
      ...
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "status", label: "状态字符", type: "text", required: !1 },
        {
          name: "format",
          label: "格式",
          type: "select",
        ...
        { name: "total", label: "仅数量", type: "flag", required: !1 },
        { name: "done", label: "已完成", type: "flag", required: !1 },
        { name: "todo", label: "未完成", type: "flag", required: !1 },
        { name: "verbose", label: "详细", type: "flag", required: !1 },
        { name: "active", label: "当前文件", type: "flag", required: !1 },
        { name: "daily", label: "今日日记", type: "flag", required: !1 },
      ],
    },
    {
      id: "task",
      ...
      params: [
        ...
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "line", label: "行号", type: "number", required: !1 },
        { name: "status", label: "状态", type: "text", required: !1 },
        { name: "toggle", label: "切换", type: "flag", required: !1 },
        { name: "done", label: "完成", type: "flag", required: !1 },
        { name: "todo", label: "待办", type: "flag", required: !1 },
        { name: "daily", label: "日记", type: "flag", required: !1 },
      ],
    },
    {
      id: "backlinks",
      ...
      params: [
        ...
        { name: "counts", label: "数量", type: "flag", required: !1 },
        { name: "total", label: "仅总数", type: "flag", required: !1 },
      ],
    },
    {
      id: "links",
    ...
    },
    {
      ...
      params: [
        ...
        { name: "total", label: "仅总数", type: "flag", required: !1 },
        { name: "counts", label: "数量", type: "flag", required: !1 },
        { name: "verbose", label: "源文件", type: "flag", required: !1 },
      ],
    },
    {
      id: "orphans",
      ...
      name: "孤立笔记（整库）",
      desc: "整库中没有被引用的文件",
      params: [{ name: "total", label: "仅总数", type: "flag", required: !1 }],
    },
    {
      id: "orphans:folder",
      category: "links",
    ...
    },
    {
      ...
      desc: "查看标签详情",
      params: [
        { name: "name", label: "标签名", type: "text", required: !0 },
        { name: "total", label: "仅数量", type: "flag", required: !1 },
        { name: "verbose", label: "文件列表", type: "flag", required: !1 },
      ],
    },
    {
      id: "properties",
      ...
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "name", label: "属性名", type: "text", required: !1 },
        {
          name: "sort",
          label: "排序",
          type: "select",
    ...
    },
    {
      ...
      desc: "设置文件属性",
      params: [
        { name: "name", label: "属性名", type: "text", required: !0 },
        { name: "value", label: "属性值", type: "text", required: !0 },
        {
          name: "type",
          label: "类型",
          type: "select",
    ...
    },
    {
      ...
      name: "列出模板",
      desc: "列出所有模板",
      params: [{ name: "total", label: "仅数量", type: "flag", required: !1 }],
    },
    {
      id: "template:read",
      category: "templates",
      ...
      desc: "读取模板内容",
      params: [
        { name: "name", label: "模板名", type: "text", required: !0 },
        { name: "title", label: "标题变量", type: "text", required: !1 },
        { name: "resolve", label: "解析变量", type: "flag", required: !1 },
      ],
    },
    {
      id: "template:insert",
    ...
    },
    {
      ...
      params: [
        ...
        { name: "total", label: "仅数量", type: "flag", required: !1 },
        { name: "verbose", label: "类型", type: "flag", required: !1 },
      ],
    },
    {
      id: "bookmark",
      ...
      desc: "添加新书签",
      params: [
        { name: "file", label: "文件", type: "text", required: !1 },
        { name: "subpath", label: "子路径", type: "text", required: !1 },
        { name: "folder", label: "文件夹", type: "text", required: !1 },
        { name: "search", label: "搜索", type: "text", required: !1 },
        { name: "url", label: "URL", type: "text", required: !1 },
        { name: "title", label: "标题", type: "text", required: !1 },
      ],
    },
    {
      id: "plugins",
      ...
      params: [
        ...
        { name: "versions", label: "版本", type: "flag", required: !1 },
      ],
    },
    {
      id: "plugins:enabled",
    ...
    },
    {
      ...
      name: "插件信息",
      desc: "查看插件详情",
      params: [{ name: "id", label: "插件ID", type: "text", required: !0 }],
    },
    {
      id: "plugin:enable",
      category: "plugins",
      ...
      desc: "启用插件",
      params: [
        { name: "id", label: "插件ID", type: "text", required: !0 },
        {
          name: "filter",
          label: "类型",
          type: "select",
    ...
    },
    {
      ...
      params: [
        { name: "id", label: "插件ID", type: "text", required: !0 },
        { name: "enable", label: "安装后启用", type: "flag", required: !1 },
      ],
    },
    {
      id: "plugin:uninstall",
    ...
    },
    {
      ...
      name: "列出主题",
      desc: "列出已安装主题",
      params: [{ name: "versions", label: "版本", type: "flag", required: !1 }],
    },
    {
      id: "theme",
      category: "themes",
      name: "当前主题",
      desc: "查看当前主题",
      params: [{ name: "name", label: "主题名", type: "text", required: !1 }],
    },
    {
      id: "theme:set",
      category: "themes",
      name: "设置主题",
      desc: "切换主题",
      params: [{ name: "name", label: "主题名", type: "text", required: !0 }],
    },
    {
      id: "theme:install",
      category: "themes",
      ...
      desc: "安装社区主题",
      params: [
        { name: "name", label: "主题名", type: "text", required: !0 },
        { name: "enable", label: "安装后启用", type: "flag", required: !1 },
      ],
    },
    {
    ...
    },
    {
      ...
      name: "启用CSS",
      desc: "启用CSS片段",
      params: [{ name: "name", label: "片段名", type: "text", required: !0 }],
    },
    {
      id: "snippet:disable",
      category: "themes",
    ...
    },
    {
      ...
      params: [
        { name: "total", label: "仅数量", type: "flag", required: !1 },
        { name: "verbose", label: "路径", type: "flag", required: !1 },
      ],
    },
    {
      id: "workspace",
      ...
      name: "工作区树",
      desc: "当前工作区布局",
      params: [{ name: "ids", label: "显示ID", type: "flag", required: !1 }],
    },
    {
      id: "workspaces",
      category: "workspace",
    ...
    },
    {
      ...
      name: "保存工作区",
      desc: "保存当前布局",
      params: [{ name: "name", label: "名称", type: "text", required: !1 }],
    },
    {
      id: "workspace:load",
      category: "workspace",
      name: "加载工作区",
      desc: "加载工作区",
      params: [{ name: "name", label: "名称", type: "text", required: !0 }],
    },
    {
      id: "workspace:delete",
      category: "workspace",
    ...
    },
    {
      ...
      desc: "打开新标签页",
      params: [
        { name: "group", label: "标签组", type: "text", required: !1 },
        { name: "file", label: "文件", type: "text", required: !1 },
        { name: "view", label: "视图", type: "text", required: !1 },
      ],
    },
    {
      id: "recents",
    ...
    },
    {
      ...
      params: [
        { name: "total", label: "仅数量", type: "flag", required: !1 },
        { name: "new", label: "新文件", type: "flag", required: !1 },
        { name: "changed", label: "已修改", type: "flag", required: !1 },
        { name: "deleted", label: "已删除", type: "flag", required: !1 },
      ],
    },
    {
      id: "publish:add",
      ...
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "changed", label: "所有变更", type: "flag", required: !1 },
      ],
    },
    {
      id: "publish:remove",
    ...
    },
    {
      ...
      desc: "暂停/恢复同步",
      params: [
        { name: "on", label: "恢复", type: "flag", required: !1 },
        { name: "off", label: "暂停", type: "flag", required: !1 },
      ],
    },
    {
      id: "sync:status",
    ...
    },
    {
      ...
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "version", label: "版本号", type: "number", required: !0 },
      ],
    },
    {
      id: "sync:restore",
    ...
    },
    {
      ...
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "from", label: "起始版本", type: "number", required: !1 },
        { name: "to", label: "目标版本", type: "number", required: !1 },
        {
          name: "filter",
          label: "来源",
          type: "select",
    ...
    },
    {
      ...
      params: [
        { name: "file", label: "文件名", type: "text", required: !1 },
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "version", label: "版本号", type: "number", required: !1 },
      ],
    },
    {
      id: "history:restore",
    ...
    },
    {
      ...
      desc: "连接/断开调试器",
      params: [
        { name: "on", label: "连接", type: "flag", required: !1 },
        { name: "off", label: "断开", type: "flag", required: !1 },
      ],
    },
    {
      id: "dev:cdp",
      ...
      desc: "执行CDP命令",
      params: [
        { name: "method", label: "方法", type: "text", required: !0 },
        { name: "params", label: "参数JSON", type: "textarea", required: !1 },
      ],
    },
    {
      id: "dev:errors",
      ...
      name: "错误日志",
      desc: "查看JS错误",
      params: [{ name: "clear", label: "清除", type: "flag", required: !1 }],
    },
    {
      id: "dev:screenshot",
      category: "dev",
      name: "截图",
      desc: "截取应用截图",
      params: [{ name: "path", label: "保存路径", type: "text", required: !1 }],
    },
    {
      id: "dev:console",
      category: "dev",
      ...
      params: [
        ...
        { name: "clear", label: "清除", type: "flag", required: !1 },
      ],
    },
    {
      id: "dev:css",
      ...
      desc: "检查CSS样式",
      params: [
        { name: "selector", label: "选择器", type: "text", required: !0 },
        { name: "prop", label: "属性", type: "text", required: !1 },
      ],
    },
    {
      id: "dev:dom",
      ...
      params: [
        { name: "selector", label: "选择器", type: "text", required: !0 },
        { name: "attr", label: "属性", type: "text", required: !1 },
        { name: "css", label: "CSS属性", type: "text", required: !1 },
        { name: "total", label: "仅数量", type: "flag", required: !1 },
        { name: "text", label: "文本", type: "flag", required: !1 },
        { name: "inner", label: "innerHTML", type: "flag", required: !1 },
        { name: "all", label: "所有", type: "flag", required: !1 },
      ],
    },
    {
      id: "dev:mobile",
      ...
      desc: "切换移动端",
      params: [
        { name: "on", label: "启用", type: "flag", required: !1 },
        { name: "off", label: "禁用", type: "flag", required: !1 },
      ],
    },
    {
      id: "eval",
    ...
    },
    {
      ...
      name: "读取随机笔记",
      desc: "读取随机笔记",
      params: [{ name: "folder", label: "文件夹", type: "text", required: !1 }],
    },
    {
      id: "web",
      category: "other",
    ...
    },
    {
      ...
      params: [
        ...
        { name: "path", label: "文件路径", type: "text", required: !1 },
        { name: "total", label: "仅数量", type: "flag", required: !1 },
        { name: "verbose", label: "文件路径", type: "flag", required: !1 },
        { name: "active", label: "当前文件", type: "flag", required: !1 },
      ],
    },
    {
      ...
      name: "命令列表",
      desc: "可用命令ID",
      params: [{ name: "filter", label: "前缀", type: "text", required: !1 }],
    },
    {
      id: "command",
      category: "other",
      name: "执行命令",
      desc: "执行Obsidian命令",
      params: [{ name: "id", label: "命令ID", type: "text", required: !0 }],
    },
    {
      id: "hotkeys",
      category: "other",
      ...
      params: [
        ...
        { name: "total", label: "仅数量", type: "flag", required: !1 },
        { name: "verbose", label: "自定义", type: "flag", required: !1 },
      ],
    },
    {
      id: "hotkey",
      ...
      desc: "命令的快捷键",
      params: [
        { name: "id", label: "命令ID", type: "text", required: !0 },
        { name: "verbose", label: "自定义", type: "flag", required: !1 },
      ],
    },
    {
    ...
    },
    {
      ...
      params: [
        { name: "file", label: "base文件名", type: "text", required: !1 },
        { name: "path", label: "路径", type: "text", required: !1 },
        { name: "view", label: "视图名", type: "text", required: !1 },
        { name: "name", label: "新条目文件名", type: "text", required: !1 },
        {
          name: "content",
          label: "条目文档内容",
          type: "textarea",
        ...
        { name: "open", label: "打开", type: "flag", required: !1 },
        { name: "newtab", label: "新标签页", type: "flag", required: !1 },
      ],
    },
    {
    ...
    },
    {
      ...
      desc: "创建唯一笔记",
      params: [
        { name: "name", label: "名称", type: "text", required: !1 },
        { name: "content", label: "内容", type: "textarea", required: !1 },
        {
          name: "paneType",
          label: "打开方式",
          type: "select",
  ...
  BUILTIN_PRESETS = [
    ...
    },
    {
      ...
      desc: "所有未完成任务",
      commandId: "tasks",
      defaultParams: { todo: !0, verbose: !0 },
      quickInput: null,
    },
    {
      id: "p-tpl",
  ...
  DEFAULT_SETTINGS = {
    ...
    moveConflictRename: !0,
    moveConflictSuffix: "number",
    showResultPanel: !0,
  };
function resolveTemplateVars(e, t) {
  var a = new Date(),
    ...
    o =
      ...
      new Date(Date.UTC(a.getUTCFullYear(), 0, 1))),
    i = i(Math.ceil(((a - o) / 864e5 + 1) / 7)),
    a = t && t.workspace ? t.workspace.getActiveFile() : null;
  let p = {
    date: s + `-${l}-` + r,
    time: n + ":" + c,
    datetime: s + `-${l}-${r} ${n}:` + c,
    ...
    title: a ? a.basename : "",
    file: a ? a.path : "",
    folder: a && a.parent ? a.parent.path : "",
  };
  return e.replace(/\{\{(\w+)\}\}/g, (e, t) => (t in p ? p[t] : `{{${t}}}`));
}
function _formatScheduleDesc(e) {
  return e
    ? "daily" === e.type
      ? "每天 " + (e.time || "08:00")
      : "weekly" === e.type
        ? `每周${["日", "一", "二", "三", "四", "五", "六"][e.weekday ?? 1]} ` +
          (e.time || "08:00")
        : "interval" === e.type
          ? `每隔 ${e.intervalMin || 60} 分钟`
          : ""
    : "";
}
function buildCommandString(e, a) {
  let i = ["obsidian", e.id];
  return (
    e.params.forEach((e) => {
      var t = a[e.name];
...
function getCategoryIcon(t) {
  return CLI_CATEGORIES.find((e) => e.id === t)?.icon || "settings";
}
function setIcon(e, t) {
  obsidian.setIcon(e, t);
}
function formatTime(e) {
  var e = new Date(e),
    t = (e) => String(e).padStart(2, "0");
  return (
    `${e.getMonth() + 1}/${e.getDate()} ${t(e.getHours())}:` + t(e.getMinutes())
  );
}
function getNewNoteFolderPath(e) {
  let t = e?.vault;
  if (t) {
    var a = (e) => {
        try {
          if ("function" == typeof t.getConfig) return t.getConfig(e);
        } catch (e) {}
        try {
          return t.config?.[e];
        } catch (e) {}
      ...
      i = a("newFileLocation"),
      a = String(a("newFileFolderPath") || "").trim();
    if ("folder" === i && a) return a.replace(/\/+$/g, "");
    if ("current" === i) {
      a = e.workspace?.getActiveFile?.();
      if (a?.path)
        return -1 === (i = a.path.lastIndexOf("/")) ? "" : a.path.slice(0, i);
    }
  }
  return "";
}
function getUniqueUntitledPath(e, t) {
  var a = e?.vault;
  let i = (t || "").replace(/\/+$/g, "");
  var s = (e) => (i ? i + "/" + e : e),
    e = s("未命名.md");
  if (!a?.getAbstractFileByPath(e)) return e;
  let l = 1;
  for (;;) {
    var r = s(`未命名_${l}.md`);
    if (!a.getAbstractFileByPath(r)) return r;
    l++;
  }
}
...
class CLICommanderView extends obsidian.ItemView {
  ...
  async onClose() {
    (this._clean(), this.containerEl.empty());
  }
  _clean() {
  ...
  _on(e, t, a) {
    (e.addEventListener(t, a),
      this._cleanups.push(() => e.removeEventListener(t, a)));
  }
  render() {
    (this._clean(), this.containerEl.empty());
    var e = this.containerEl.createDiv({ cls: "cli-root" }),
      t =
        (this._renderNav(e),
        (this._resultPanel = e.createDiv({
          cls: "cli-result-panel is-hidden",
        })),
        e.createDiv({ cls: "cli-content" }));
    switch (this.page) {
      case "home":
        this._renderHome(t);
        break;
      case "builder":
        this._renderBuilder(t);
        break;
      case "presets":
        this._renderPresets(t);
        break;
      case "workflows":
        this._renderWorkflows(t);
        break;
      case "history":
        this._renderHistory(t);
        break;
      case "eval":
        this._renderEvalSandbox(t);
    }
  }
  _renderNav(e) {
...
此操作可能不可逆，确定执行吗？`,
  ...
  _refreshPresetList(e) {
    (e.empty(), this._renderPresetsBody(e));
  }
  _renderPresetsBody(e) {
  ...
  _renderPresetCard(i, l, e, s, t, a, r) {
  ...
  _renderHomeItemCard(e, i, t, a, s, l) {
  ...
  _formatScheduleDesc(e) {
    return _formatScheduleDesc(e);
  }
  _renderWorkflowEditor(e) {
    let g = this.wfEditor,
      t = null !== g.editIdx;
  ...
  async _runWorkflow(e) {
    var { combined: t, success: a } = await this.plugin.runWorkflow(e);
    (this._showResult(t, !a),
      this._addHistory(
        e.steps.map((e) => e.label || e.command).join(" → "),
        { id: "workflow", name: "序列: " + e.name },
        t,
        a,
        e,
      ));
  }
  async _runWorkflow_legacy(e) {
    var s = [];
    let l = "";
    ...
    for (let i = 0; i < e.steps.length; i++) {
      let t = e.steps[i];
      var r = l.trim(),
        n = /\{上一步结果\}|\{prev\}/.test(t.command);
      let a = t.command;
      var c = {};
      if (/^obsidian\s+agent\b/.test(a)) {
        var o = [];
        for (let e = 0; e < i; e++) {
          var p = s[e];
          p &&
            o.push(
              `步骤${p.step}: ${p.command}
结果: ` + (p.result || "(无输出)").substring(0, 2e3),
            );
        }
        0 < o.length && (c.__workflowContext = o.join("\n\n"));
      }
      if (t.batchMode && r) {
        var d,
          u = r
          ...
          m =
            (new obsidian.Notice(
              `步骤 ${i + 1}/${e.steps.length}: 批量执行 ${u.length} 项`,
            ),
            this.app.vault),
          h = t.command.match(
            /^obsidian\s+move\b.*?\bto=("([^"]*)"|([^\s"]+))/,
          );
        if (h) {
          let e = "";
          for (d of (void 0 !== h[2] ? h[2] : h[3]).split("/"))
            if (((e = e ? e + "/" + d : d), !m.getAbstractFileByPath(e)))
              try {
                await m.createFolder(e);
              } catch (e) {}
        }
        var g = t.command.match(
            /^obsidian\s+rename\b.*?\bname=("([^"]*)"|([^\s"]+))/,
          ),
          v = new Map();
        if (g) {
          var f,
            b = void 0 !== g[2] ? g[2] : g[3],
            y = new Map();
          for (f of u) {
            let a = f.includes("/") ? f.substring(0, f.lastIndexOf("/")) : "";
            var w = f.includes("/") ? f.split("/").pop() : f,
              x = w.lastIndexOf("."),
              w = 0 < x ? w.substring(x) : "",
              x = 0 < b.lastIndexOf("."),
              _ = x ? b.substring(0, b.lastIndexOf(".")) : b,
              E = x ? b.substring(b.lastIndexOf(".")) : w,
              x = _ + E;
            if (!y.has(a)) {
              let t = new Set();
              (m
                ...
                .forEach((e) => t.add(e.name)),
                y.set(a, t));
            }
            var k = y.get(a);
            let e = x,
              t = 1;
            for (; k.has(e); ) ((e = _ + "_" + t + E), t++);
            (k.add(e), v.set(f, e));
          }
        }
        var S,
        ...
        for (S of u) {
          ...
          (g &&
            v.has(S) &&
            (e = e.replace(/\bname=("[^"]*"|[^\s"]+)/, `name="${v.get(S)}"`)),
            h &&
              ((I = void 0 !== h[2] ? h[2] : h[3]),
              (C = S.includes("/") ? S.split("/").pop() : S),
              (I = I.replace(/\/$/, "") + "/" + C),
              (e = e.replace(/\bto=("[^"]*"|[^\s"]+)/, `to="${I}"`))));
          try {
            var q = await this.plugin.executeCLI(e),
              P = q ? q.trim() : "";
            if (P && /^Error:/i.test(P)) {
              if (/already exists/i.test(P)) D.push(`⏭ ${S}: 已存在，跳过`);
              else if ((D.push(`❌ ${S}: ` + P), !t.continueOnError)) {
                new obsidian.Notice(
                  `批量步骤 ${i + 1} 中 "${S}" 失败，序列已停止`,
                );
                break;
              }
            } else D.push("✅ " + S + (P ? ": " + P : ""));
            ...
            if (/already exists/i.test(e.message))
              D.push(`⏭ ${S}: 已存在，跳过`);
            else if ((D.push(`❌ ${S}: ` + e.message), !t.continueOnError)) {
              new obsidian.Notice(
                `批量步骤 ${i + 1} 中 "${S}" 失败，序列已停止`,
              );
              break;
        ...
        ((l = u),
          s.push({
            ...
            command: t.command,
            result: u,
            success: !D.some((e) => e.startsWith("❌")),
          }),
          0 < t.sleep &&
            i < e.steps.length - 1 &&
            (await new Promise((e) => setTimeout(e, t.sleep))));
      } else {
        u =
          n &&
          a.match(/^obsidian\s+(daily:append|daily:prepend|append|prepend)\b/);
        if (n && u) {
          new obsidian.Notice(
            `步骤 ${i + 1}/${e.steps.length}: ` + (t.label || t.command),
          );
          try {
            var L = await this._execPrevWrite(a, r);
            ((l = L),
              s.push({
                step: i + 1,
                command: t.command,
          ...
          if (
            ...
            try {
              var M = new (Object.getPrototypeOf(
                  async function () {},
                ).constructor)(
                  "app",
                  "plugin",
            ...
            try {
              var $ = await this.plugin.executeCLI(a, c);
              ((l = $),
                s.push({
                  step: i + 1,
                  command: t.command,
...
` + (e.result || "(无输出)"),
  ...
  _parseParam(e, t) {
    ...
    return a
      ...
      : (a = e.match(new RegExp(t + "=([^\\s]+)")))
        ? a[1]
        : null;
  }
  async _execPrevWrite(a, t) {
    var i = this.app.vault,
      s = a.match(
        /^obsidian\s+(daily:append|daily:prepend|append|prepend)\b/,
      )[1],
      l = s.startsWith("daily:"),
      s = s.endsWith("prepend");
    let e = this._parseParam(a, "content") || "";
    e = e.replace(/\{上一步结果\}|\{prev\}/g, t);
    t = /\binline\b/.test(a) ? e : "\n" + e;
    if (l) {
      var l = this.app.internalPlugins?.getPluginById("daily-notes"),
        r = window.moment;
      if (!r) throw new Error("moment.js 不可用");
      var n = l?.instance?.options?.format || "YYYY-MM-DD",
        l = l?.instance?.options?.folder || "",
        r = r().format(n),
        n = l ? l + `/${r}.md` : r + ".md";
      let e = i.getAbstractFileByPath(n);
      e || (await i.create(n, ""), (e = i.getAbstractFileByPath(n)));
      l = await i.read(e);
      return (await i.modify(e, s ? t + "\n" + l : l + t), "");
    }
    {
      let e = this._parseParam(a, "path");
      if (!e) {
        let t = this._parseParam(a, "file");
        if (t) {
          r = i
            .getFiles()
            .find(
              (e) => e.basename === t || e.name === t || e.name === t + ".md",
            );
          if (!r) throw new Error(`文件 "${t}" 未找到`);
          e = r.path;
        } else {
          n = this.app.workspace.getActiveFile();
          if (!n) throw new Error("没有活跃文件，请指定 file 或 path 参数");
          e = n.path;
        }
      }
      l = i.getAbstractFileByPath(e);
      if (l)
        return (
          (a = await i.read(l)),
          await i.modify(l, s ? t + "\n" + a : a + t),
          ""
        );
      throw new Error(`文件 "${e}" 未找到`);
    }
  }
  static _getDragLine() {
    let e = document.getElementById("cli-drag-line");
    return (
      e ||
        (((e = document.createElement("div")).id = "cli-drag-line"),
        (e.style.cssText =
  ...
  static _showDragLine(e, t) {
    var a = CLICommanderView._getDragLine(),
      e = e.getBoundingClientRect(),
      t = t ? e.bottom : e.top;
    ((a.style.top = t - 1 + "px"),
      (a.style.left = e.left + "px"),
      (a.style.right = window.innerWidth - e.right + "px"),
      (a.style.display = "block"));
  }
  static _hideDragLine() {
    var e = document.getElementById("cli-drag-line");
...
class ConfirmModal extends obsidian.Modal {
  constructor(e, t, a, i) {
    (super(e), (this._t = t), (this._m = a), (this._cb = i));
  }
  onOpen() {
    var e = this.contentEl,
      e =
        (e.empty(),
        e.addClass("cli-confirm-modal"),
        e.createEl("h3", { text: this._t }),
        e.createEl("p", { text: this._m, cls: "cli-confirm-message" }),
        e.createDiv({ cls: "cli-confirm-actions" }));
    (e
      .createEl("button", { text: "取消", cls: "cli-btn-cancel" })
      .addEventListener("click", () => {
        (this._cb(!1), this.close());
      }),
      e
        .createEl("button", { text: "确认执行", cls: "cli-btn-exec is-danger" })
        .addEventListener("click", () => {
          (this._cb(!0), this.close());
        }));
  }
  onClose() {
...
class ResultModal extends obsidian.Modal {
  constructor(e, t, a) {
    (super(e), (this._c = t), (this._r = a));
  }
  onOpen() {
    var e = this.contentEl,
      e =
        (e.empty(),
        e.addClass("cli-result-modal"),
        e.createEl("h3", { text: "执行结果" }),
        e.createDiv({ cls: "cli-result-modal-cmd", text: this._c }),
        e
          .createEl("pre", { cls: "cli-result-modal-pre" })
          .createEl("code", { text: this._r || "(无输出)" }),
        e.createDiv({ cls: "cli-result-modal-actions" })),
      t = e.createEl("button", { cls: "cli-btn-small" });
    (obsidian.setIcon(t, "clipboard"),
      t.createSpan({ text: " 复制结果" }),
      t.addEventListener("click", () => {
        (navigator.clipboard.writeText(this._r), new obsidian.Notice("已复制"));
      }),
      e
...
class SavePresetModal extends obsidian.Modal {
  constructor(e, t, a, i) {
    (super(e), (this._cmd = t), (this._vals = a), (this._cb = i));
  }
  onOpen() {
    var e = this.contentEl,
      t =
        (e.empty(),
        e.addClass("cli-save-preset-modal"),
        e.createEl("h3", { text: "保存为预设" }),
        e.createDiv({ cls: "cli-save-form" }));
    t.createEl("label", { text: "预设名称" });
    let a = t.createEl("input", {
        cls: "cli-param-input",
        attr: {
          type: "text",
      ...
      i =
        (t.createEl("label", { text: "描述" }),
        t.createEl("input", {
          cls: "cli-param-input",
          attr: { type: "text", placeholder: "简短描述（可选）" },
        })),
      s = buildCommandString(this._cmd, this._vals),
      l =
        (t.createEl("label", { text: "命令" }),
        t.createDiv({ cls: "cli-preview-box" }).createEl("code", { text: s }),
        (this._cmd.params || []).filter((e) =>
          QUICK_INPUT_PARAM_NAMES.includes(e.name),
        )),
      r = new Set();
    if (0 < l.length) {
      (t.createEl("label", {
        ...
        t.createDiv({ cls: "cli-save-quick-hint" }).createSpan({
          text: "勾选后，卡片上会显示对应参数的输入框，执行时自动填充。",
        }));
      let s = t.createDiv({ cls: "cli-save-quick-grid" });
      l.forEach((e) => {
        var t = s.createDiv({ cls: "cli-save-quick-row" });
        let a = t.createEl("input", {
          attr: { type: "checkbox", id: "qi-" + e.name },
        });
        ((void 0 !== this._vals[e.name] &&
          "" !== this._vals[e.name] &&
          !1 !== this._vals[e.name]) ||
          ((a.checked = !0), r.add(e.name)),
          a.addEventListener("change", () => {
            a.checked ? r.add(e.name) : r.delete(e.name);
          }));
        var t = t.createEl("label", { attr: { for: "qi-" + e.name } }),
          i =
            (t.createSpan({
        ...
        t.createSpan({ cls: "cli-save-quick-ptype", text: ` (${i})` });
      });
    }
    ((t = e.createDiv({ cls: "cli-confirm-actions" })),
      t
        .createEl("button", { text: "取消", cls: "cli-btn-cancel" })
        .addEventListener("click", () => this.close()),
      (e = t.createEl("button", { cls: "cli-btn-exec" })));
    (obsidian.setIcon(e, "save"),
      e.createSpan({ text: " 保存" }),
        ...
        (0 < r.size &&
          (e = l
            ...
            .map((e) => ({
              ...
              type: "textarea" === e.type ? "textarea" : "input",
              placeholder: e.placeholder || `输入${e.label || e.name}...`,
            }))),
          this._cb({
            name: a.value || this._cmd.name,
            desc: i.value,
            lucideIcon: "zap",
...
class WorkflowEditorModal extends obsidian.Modal {
  constructor(e, t, a, i) {
    (super(e),
      (this._p = t),
      (this._wf = a ? JSON.parse(JSON.stringify(a)) : { name: "", steps: [] }),
      (this._cb = i));
  }
  onOpen() {
    (this.contentEl.empty(),
  ...
  _render() {
    var e = this.contentEl,
      t =
        (e.empty(),
        e.createEl("h3", {
          text: this._wf.name ? "编辑命令序列" : "新建命令序列",
        }),
        e.createDiv({ cls: "cli-save-form" }));
    t.createEl("label", { text: "序列名称" });
    let a = t.createEl("input", {
        cls: "cli-param-input",
        attr: {
          type: "text",
      ...
      s =
        (a.addEventListener("input", () => {
          this._wf.name = a.value;
        }),
        e.createDiv({ cls: "cli-wf-steps-section" }));
    (s.createEl("label", { text: "步骤列表" }),
      s.createDiv({
        cls: "cli-wf-hint",
        text: "使用 {上一步结果} 或 {prev} 引用上一步的输出",
      }),
      this._wf.steps.forEach((e, t) => {
        var a = s.createDiv({ cls: "cli-wf-step-row" });
        a.createSpan({ cls: "cli-wf-step-num", text: "" + (t + 1) });
        let i = a.createEl("input", {
          cls: "cli-param-input cli-wf-step-input",
          attr: { type: "text", value: e.command, placeholder: "obsidian ..." },
        });
        i.addEventListener("input", () => {
          e.command = i.value;
        });
        a = a.createEl("button", { cls: "cli-wf-step-del" });
        (obsidian.setIcon(a, "x"),
          a.addEventListener("click", () => {
            (this._wf.steps.splice(t, 1), this._render());
          }));
      }));
    ((t = s.createEl("button", { cls: "cli-btn-add" })),
      obsidian.setIcon(t, "plus"),
      t.createSpan({ text: " 添加步骤" }),
      t.addEventListener("click", () => {
        (this._wf.steps.push({ command: "", continueOnError: !1 }),
          this._render());
      }),
      (t = e.createDiv({ cls: "cli-confirm-actions" })),
      t
    ...
    (obsidian.setIcon(e, "save"),
      ...
      e.addEventListener("click", () => {
        this._wf.name.trim()
          ? this._wf.steps.length
            ? (this._cb(this._wf), this.close())
            : new obsidian.Notice("请至少添加一个步骤")
          : new obsidian.Notice("请输入序列名称");
      }));
  }
...
class WorkflowResultModal extends obsidian.Modal {
  constructor(e, t, a) {
    (super(e), (this._n = t), (this._r = a));
  }
  onOpen() {
    let i = this.contentEl;
    (i.empty(),
      i.addClass("cli-wf-result-modal"),
      i.createEl("h3", { text: "序列结果: " + this._n }),
      this._r.forEach((e) => {
        var t = i.createDiv({
            cls: "cli-wf-result-item " + (e.success ? "" : "is-error"),
          }),
          a =
            (t.createDiv({
              cls: "cli-wf-result-step",
              text: `步骤 ${e.step}: ` + e.command,
            }),
            t.createSpan({ cls: "cli-wf-result-status" }));
        (obsidian.setIcon(a, e.success ? "check-circle" : "x-circle"),
          t
            .createEl("pre", { cls: "cli-result-modal-pre" })
            .createEl("code", { text: e.result || "(无输出)" }));
      }),
      i
...
class QuickInputModal extends obsidian.Modal {
  constructor(e, t, a, i, s) {
    (super(e), (this._p = t), (this._t = a), (this._ph = i), (this._cb = s));
  }
  onOpen() {
    var e = this.contentEl;
    (e.empty(),
      e.addClass("cli-quick-modal"),
      e.createEl("h3", { text: this._t }));
    let t = e.createEl("input", {
      cls: "cli-param-input cli-quick-input",
      attr: { type: "text", placeholder: this._ph },
    });
    t.focus();
    ((e = e.createDiv({ cls: "cli-confirm-actions" })),
      e
        .createEl("button", { text: "取消", cls: "cli-btn-cancel" })
        .addEventListener("click", () => this.close()),
      (e = e.createEl("button", { cls: "cli-btn-exec" })));
    (obsidian.setIcon(e, "play"), e.createSpan({ text: " 执行" }));
    let a = () => {
      var e = t.value.trim();
      e ? (this._cb(e), this.close()) : new obsidian.Notice("请输入内容");
    };
...
class CLICommanderSettingTab extends obsidian.PluginSettingTab {
  constructor(e, t) {
    (super(e, t), (this.plugin = t));
  }
  display() {
    let a = this.containerEl;
    (a.empty(),
      a.createEl("h2", { text: "CLI Commander 设置" }),
      new obsidian.Setting(a)
        .setName("显示命令预览")
        .setDesc("在构建器中显示生成的CLI命令")
        .addToggle((e) =>
          e
            .setValue(this.plugin.settings.showCommandPreview)
            .onChange(async (e) => {
              ((this.plugin.settings.showCommandPreview = e),
                await this.plugin.saveSettings());
            }),
        ),
      new obsidian.Setting(a)
        .setName("执行后显示结果面板")
        .setDesc(
          "执行命令后在底部显示结果面板，关闭后仍可通过 Notice 查看简短提示",
        )
        .addToggle((e) =>
          e
            .setValue(this.plugin.settings.showResultPanel ?? !0)
            .onChange(async (e) => {
              ((this.plugin.settings.showResultPanel = e),
                await this.plugin.saveSettings());
            }),
        ),
      new obsidian.Setting(a)
        ...
        .addToggle((e) =>
          e
            .setValue(this.plugin.settings.confirmDangerous)
            .onChange(async (e) => {
              ((this.plugin.settings.confirmDangerous = e),
                await this.plugin.saveSettings());
            }),
        ),
      new obsidian.Setting(a)
        ...
        .addText((e) =>
          e
            ...
            .onChange(async (e) => {
              ...
              !isNaN(e) &&
                0 < e &&
                ((this.plugin.settings.maxHistory = e),
                await this.plugin.saveSettings());
            }),
        ),
      a.createEl("h3", { text: "文件移动" }),
      new obsidian.Setting(a)
        .setName("同名文件自动重命名")
        .setDesc(
          "执行 move 命令时，若目标路径已存在同名文件，自动在文件名后追加后缀而不是跳过",
        )
        .addToggle((e) =>
          e
            .setValue(this.plugin.settings.moveConflictRename ?? !0)
            .onChange(async (e) => {
              ((this.plugin.settings.moveConflictRename = e),
                await this.plugin.saveSettings(),
                this.display());
            }),
        ),
      this.plugin.settings.moveConflictRename &&
        new obsidian.Setting(a)
          .setName("后缀方式")
          ...
          .addDropdown((e) =>
            e
              ...
              .onChange(async (e) => {
                ((this.plugin.settings.moveConflictSuffix = e),
                  await this.plugin.saveSettings());
              }),
          ),
      a.createEl("h3", { text: "数据管理" }),
      new obsidian.Setting(a)
        .setName("清空执行历史")
      ...
      a.createEl("h3", { text: "内置预设管理" }));
    var e = this.plugin.settings.hiddenBuiltinPresets || [];
    e.length
      ? (e.forEach((t) => {
          var e = BUILTIN_PRESETS.find((e) => e.id === t);
          e &&
            new obsidian.Setting(a)
              .setName(e.name)
              .setDesc(e.desc || "")
              .addButton((e) =>
                e.setButtonText("恢复").onClick(async () => {
                  ((this.plugin.settings.hiddenBuiltinPresets = (
                    this.plugin.settings.hiddenBuiltinPresets || []
                  ).filter((e) => e !== t)),
                    await this.plugin.saveSettings(),
        ...
        new obsidian.Setting(a).setName("恢复全部隐藏预设").addButton((e) =>
          e
            .setButtonText("全部恢复")
            .setWarning()
            .onClick(async () => {
...
class CLICommanderPlugin extends obsidian.Plugin {
  ...
  async checkContentProtectionStatus() {
    try {
      var e = this.app.plugins.plugins["obsidian-content-protection"];
      if (e) {
        if (!this.app.plugins.enabledPlugins.has("obsidian-content-protection"))
          return !1;
        if (e.settings)
          return (
            !!(
              !0 === e.settings.isActivated &&
              e.settings.deviceId &&
              0 < e.settings.deviceId.trim().length &&
              !0 === e.settings.hasBeenActivated
  ...
  async validateContentProtectionIntegrity() {
    try {
      var e = await this.app.vault.adapter.read(
          ".obsidian/plugins/obsidian-content-protection/manifest.json",
        ),
        t = JSON.parse(e),
        a = t.version;
      if (!a) return !1;
      if (compareVersions(a, "1.3.0") < 0) return !1;
      if ("ytmaps" !== t.author) return !1;
      try {
        if (
          !(await validatePluginIntegrity(
            t,
            ".obsidian/plugins/obsidian-content-protection",
          ))
        )
          return !1;
        var i = generateSecureHash(`${t.id}:${t.author}:` + t.version);
        if (!(i && "function" == typeof i.then ? await i : i)) return !1;
      } catch (e) {}
      return !0;
    } catch (e) {
      return !1;
  ...
  async checkContentProtectionFile() {
    try {
      var e, t;
      return this.app.plugins.enabledPlugins.has("obsidian-content-protection")
        ? ((e = await this.app.vault.adapter.read(
            ".obsidian/plugins/obsidian-content-protection/data.json",
          )),
          !!(
            !0 === (t = JSON.parse(e)).isActivated &&
            t.deviceId &&
            0 < t.deviceId.trim().length &&
  ...
  async checkAndUpdateStatus() {
    var e = await this.checkContentProtectionStatus();
    !e && this.isPluginActivated
      ? ((this.isPluginActivated = !1), this.disablePluginFeatures())
      : e &&
        !this.isPluginActivated &&
        ((this.isPluginActivated = !0), await this.initializePluginFeatures());
  }
  ...
  showActivationRequired() {
    this.app.plugins.enabledPlugins.has("obsidian-content-protection");
  }
  async initializePluginFeatures() {
    ((this.statusCheckInterval = window.setInterval(() => {
      ...
      this.registerView(VIEW_TYPE, (e) => new CLICommanderView(e, this)),
      ...
      this.addCommand({
        ...
        callback: () => {
          this.isPluginActivated && this.activateView();
        },
      }),
      this.addCommand({
        ...
        callback: () => {
          this.isPluginActivated &&
            new QuickInputModal(
              ...
              "输入要追加到今日日记的内容...",
              async (e) => {
                e = `obsidian daily:append content="${e.replace(/"/g, '\\"')}"`;
                try {
                  (await this.executeCLI(e),
        ...
        callback: () => {
          this.isPluginActivated &&
            new QuickInputModal(
              ...
              "输入搜索关键词...",
              async (e) => {
                e = `obsidian search:context query="${e.replace(/"/g, '\\"')}"`;
                try {
                  var t = await this.executeCLI(e);
                  new ResultModal(this.app, e, t).open();
                } catch (e) {
                  new obsidian.Notice("❌ 失败: " + e.message);
                }
              },
      ...
      this.registerEvent(
        this.app.workspace.on("file-menu", (e, a) => {
          (e.addItem((e) =>
            e
              .setTitle("CLI: 查看文件信息")
              .setIcon("waypoints")
              .onClick(async () => {
                var e = `obsidian file path="${a.path}"`;
                try {
                  var t = await this.executeCLI(e);
                  new ResultModal(this.app, e, t).open();
                } catch (e) {
            ...
            e.addItem((e) =>
              e
                ...
                .onClick(async () => {
                  var e = `obsidian backlinks path="${a.path}" counts`;
                  try {
                    var t = await this.executeCLI(e);
                    new ResultModal(this.app, e, t).open();
                  } catch (e) {
            ...
            e.addItem((e) =>
              e
                ...
                .setIcon("file-text")
                .onClick(async () => {
                  var e = `obsidian wordcount path="${a.path}"`;
                  try {
                    var t = await this.executeCLI(e);
                    new ResultModal(this.app, e, t).open();
                  } catch (e) {
  ...
  async onload() {
    (await this.checkContentProtectionStatus())
      ? ((this.isPluginActivated = !0), await this.initializePluginFeatures())
      : ((this.isPluginActivated = !1), this.showActivationRequired());
  }
  async onload_old() {
    (await this.loadSettings(),
      this.registerView(VIEW_TYPE, (e) => new CLICommanderView(e, this)),
  ...
  _startScheduler() {
    (this._schedTimer && clearInterval(this._schedTimer),
      (this._schedTimer = setInterval(() => this._checkSchedules(), 6e4)));
  }
  async _checkSchedules() {
    var t,
      ...
      s = a.getDay();
    for (t of this.settings.workflows || []) {
      var l = t.schedule;
      if (l && l.enabled) {
        let e = !1;
        if (
          ...
          var r = t.name + `_${i}_` + a.toDateString();
          if (!this._schedRan || !this._schedRan.has(r)) {
            (this._schedRan || (this._schedRan = new Set()),
              this._schedRan.add(r),
              200 < this._schedRan.size && this._schedRan.clear(),
              new obsidian.Notice("⏰ 定时执行序列：" + t.name));
            try {
              var { combined: n, success: c } = await this.runWorkflow(t),
                o =
                  this.app.workspace.getLeavesOfType("cli-commander")[0]?.view;
              o
                ? (o._showResult(n, !c),
                  o._addHistory(
                    t.steps.map((e) => e.label || e.command).join(" → "),
                    { id: "workflow", name: "序列: " + t.name },
                    n,
                    c,
                    t,
                  ))
      ...
      if (t.batchMode && r) {
        var d,
          ...
          m =
            ...
            this.app.vault),
          h = t.command.match(/^obsidian\s+move\b.*?\bto=("([^"]*)"|(\S+))/);
        if (h) {
          let e = "";
          for (d of (void 0 !== h[2] ? h[2] : h[3]).split("/"))
            if (((e = e ? e + "/" + d : d), !m.getAbstractFileByPath(e)))
        ...
        if (n && u) {
          ...
          try {
            var L = await this._pluginExecPrevWrite(a, r);
            ((l = L),
              s.push({
                step: i + 1,
                command: t.command,
          ...
          if (
            ...
            try {
              var M = await this.executeCLI(a, c);
              ((l = M),
                s.push({
                  step: i + 1,
                  command: t.command,
...
` + (e.result || "(无输出)"),
        ...
        .join("\n\n"),
      a = !s.some((e) => !e.success);
    return { results: s, combined: t, success: a };
  }
  async _pluginExecPrevWrite(a, t) {
    var i = this.app.vault,
      s = a.match(
        /^obsidian\s+(daily:append|daily:prepend|append|prepend)\b/,
      )[1],
    ...
    e = (e = e
      .replace(/\\"/g, '"')
      .replace(/\\n/g, "\n")
      .replace(/\\t/g, "\t")).replace(/\{上一步结果\}|\{prev\}/g, t);
    t = /\binline\b/.test(a) ? e : "\n" + e;
    if (l) {
      var l = this.app.internalPlugins?.getPluginById("daily-notes"),
        r = window.moment;
  ...
  async activateView() {
    ...
    let a = t.getLeavesOfType(VIEW_TYPE)[0];
    (a ||
      ((e = t.getLeftLeaf(!1)) &&
        (await (a = e).setViewState({ type: VIEW_TYPE, active: !0 }))),
      a && t.revealLeaf(a));
  }
  async loadSettings() {
  ...
  _getObsidianBin() {
    if (!this._obsidianBin) {
      var e,
        t = -1 < navigator.platform.indexOf("Win"),
        a = require("child_process").execSync,
        i = require("path");
      if (t) {
        var s,
          l = require("fs");
        for (s of [
          ...
          i.join(process.env.LOCALAPPDATA || "", "Obsidian", "Obsidian.com"),
          i.join(process.env.PROGRAMFILES || "", "Obsidian", "Obsidian.com"),
        ])
          try {
            if (l.existsSync(s))
              return ((this._obsidianBin = s), this._obsidianBin);
          } catch (e) {}
      } else {
        for (e of [
          ...
          try {
            if (require("fs").existsSync(e))
              return ((this._obsidianBin = e), this._obsidianBin);
          } catch (e) {}
        try {
          var r = a("which obsidian 2>/dev/null", { timeout: 3e3 })
            .toString()
            .trim();
          if (r) return ((this._obsidianBin = r), this._obsidianBin);
        } catch (e) {}
      }
  ...
  _resolveConflictPath(e) {
    var t = this.app.vault;
    if (!t.getAbstractFileByPath(e)) return e;
    var a = e.lastIndexOf("."),
      i = e.lastIndexOf("/") + 1 < a,
      s = i ? e.slice(0, a) : e,
      l = i ? e.slice(a) : "";
    if ("timestamp" === this.settings.moveConflictSuffix)
      return (
        s +
        "_" +
        new Date()
    ...
    let r = 1,
      n;
    for (; (n = s + "_" + r + l), r++, t.getAbstractFileByPath(n); );
    return n;
  }
  _getFlowTextPlugin() {
    return this.app.plugins?.plugins?.flowtext || null;
  }
  async _executeAgent(e, t) {
    var a = this._getFlowTextPlugin();
    if (!a) throw new Error("FlowText 插件未安装或未启用，无法使用 Agent 功能");
    if ("function" != typeof a.runAgentTask)
      throw new Error("FlowText 插件版本过低，请更新以支持 Agent API");
    var i = e.match(/content="((?:[^"\\]|\\.)*)"/),
      s = !i && e.match(/content=(\S+)/),
      i = i ? i[1].replace(/\\"/g, '"').replace(/\\\\/g, "\\") : s ? s[1] : "";
    if (!i) throw new Error("agent 命令缺少 content 参数，请指定任务描述");
    ((s = e.match(/\bpath="((?:[^"\\]|\\.)*)"/)),
      (e = !s && e.match(/\bpath=(\S+)/)),
      (s = s ? s[1].replace(/\\"/g, '"') : e ? e[1] : ""),
      (e = (t && t.__workflowContext) || ""));
    let l = null;
    if (s) {
      t = this.app.vault.getAbstractFileByPath(s);
      if (!(t instanceof obsidian.TFile)) throw new Error(`文件 "${s}" 未找到`);
      l = t;
    }
    for (
      new obsidian.Notice("🤖 Agent 处理: " + (s || i.slice(0, 30)));
      this._agentRunning;
    )
      await new Promise((e) => setTimeout(e, 500));
    this._agentRunning = !0;
    t = {
      showPanel: !!!this.app.workspace.getLeavesOfType(
        "flowtext-agent-view",
      )[0],
    };
    (e && (t.context = e), s && (t.filePath = s));
    let r;
    ((e = this.app.workspace),
      (s = e.getActiveFile ? e.getActiveFile.bind(e) : null));
    try {
      (l && s && (e.getActiveFile = () => l), (r = await a.runAgentTask(i, t)));
    } finally {
      (s && (e.getActiveFile = s), (this._agentRunning = !1));
    }
    if (r && r.success) return r.answer || "(Agent 任务完成)";
    throw new Error(r?.answer || "Agent 任务执行失败");
  }
  async executeCLI(r, e) {
    if (((r = resolveTemplateVars(r, this.app)), /^obsidian\s+agent\b/.test(r)))
      return this._executeAgent(r, e);
    if (/^obsidian\s+orphans:folder\b/.test(r)) {
      var l = r.match(/\bfolder=("([^"]*)"|([^\s"]+))/),
        n = r.match(/\bext=("([^"]*)"|([^\s"]+))/),
        c = /\btotal\b/.test(r),
        l = l ? (void 0 !== l[2] ? l[2] : l[3]) : "",
        n = n ? (void 0 !== n[2] ? n[2] : n[3]) : "";
      let e = this.app.vault;
      var o,
        p,
        d,
        u = this.app.metadataCache;
      let t = new Set();
      for (o of Object.values(u.resolvedLinks))
        for (var m of Object.keys(o)) t.add(m);
      let a = new Set();
      for ([p, d] of Object.entries(u.resolvedLinks))
        0 < Object.keys(d).length && a.add(p);
      var h,
        g = [];
      for (h of e.getMarkdownFiles()) {
        var v = u.getFileCache(h);
        if (v) {
          if (v.frontmatter)
            for (var [f, b] of Object.entries(v.frontmatter))
              "position" !== f &&
                "tags" !== f &&
                "string" == typeof b &&
                b.trim() &&
                (f = u.getFirstLinkpathDest(b, h.path)) &&
                (t.add(f.path), a.add(h.path));
          v.sections && g.push(h);
        }
      }
      var y,
        w = g.map((t) =>
          e
            .cachedRead(t)
            .then((e) => ({ file: t, content: e }))
            .catch(() => null),
        );
      for (y of await Promise.all(w))
        if (y) {
          var x,
            { file: _, content: E } = y;
          for (x of E.matchAll(/src=["']([^"']+)["']/g)) {
            var k = decodeURIComponent(x[1]),
              k = u.getFirstLinkpathDest(k, _.path);
            k && (t.add(k.path), a.add(_.path));
          }
        }
      let i;
      if ("all" === n) i = e.getFiles();
      else if (n && "" !== n) {
        let t = n
          .split(",")
          .map((e) => e.trim().toLowerCase().replace(/^\./, ""));
        i = e.getFiles().filter((e) => {
          e = e.extension.toLowerCase();
          return t.includes(e);
        });
      } else i = e.getMarkdownFiles();
      let s = l.replace(/\/$/, "") + "/";
      w = (l ? i.filter((e) => e.path.startsWith(s)) : i).filter(
        (e) => !t.has(e.path) && !a.has(e.path),
      );
      return c
        ? String(w.length)
        : w.length
    ...
    this.settings.moveConflictRename &&
      (n = r.match(/^obsidian\s+move\b(.*?)\bto=("([^"]*)"|([^\s"]+))(.*)/)) &&
      ((c = void 0 !== n[3] ? n[3] : n[4]),
      (w = this._resolveConflictPath(c)) !== c) &&
      (r = r.replace(/\bto=("[^"]*"|[^\s"]+)/, `to="${w}"`));
    l = -1 < navigator.platform.indexOf("Win");
    let t = require("child_process").exec,
      S = this._getObsidianBin();
    n =
      "obsidian" !== S && (S.includes(" ") || S.includes("\\")) ? `"${S}"` : S;
    let C = r.replace(/^obsidian\b/, n),
      a = {
        timeout: 3e4,
        maxBuffer: 1048576,
        encoding: "utf8",
        env: Object.assign({}, process.env, e || {}),
      };
