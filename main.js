...
function generateSecureHash(e, t = null) {
  e = (t = t || `cli_salt_${Math.floor(Date.now() / 864e5)}_security`) + e + t;
...
class CLICommanderPlugin extends obsidian.Plugin {
  ...
  async checkContentProtectionStatus() {
    try {
      var e = this.app.plugins.plugins["obsidian-cli-gui"];
      if (e) {
  ...
  async checkContentProtectionFile() {
    try {
      var e, t;
      return this.app.plugins.enabledPlugins.has("obsidian-cli-gui")
